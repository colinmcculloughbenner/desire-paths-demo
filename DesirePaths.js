...
// include: /var/folders/3x/fdmqc0bj3mx9qsq8nthrnt0h0000gn/T/tmpb99kz98i.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'DesirePaths.data';
      var REMOTE_PACKAGE_BASE = 'DesirePaths.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_DesirePaths.data');

      };
      Module['addRunDependency']('datafile_DesirePaths.data');
    ...
    loadPackage({"files": [{"filename": "/resources/DesirePaths.ldtk", "start": 0, "end": 441761}, {"filename": "/resources/Tileset.ase", "start": 441761, "end": 445120}, {"filename": "/resources/Tileset.png", "start": 445120, "end": 448824}], "remote_package_size": 448824});

  })();

// end include: /var/folders/3x/fdmqc0bj3mx9qsq8nthrnt0h0000gn/T/tmpb99kz98i.js
// include: /var/folders/3x/fdmqc0bj3mx9qsq8nthrnt0h0000gn/T/tmphmiamnaf.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/3x/fdmqc0bj3mx9qsq8nthrnt0h0000gn/T/tmphmiamnaf.js
// include: /var/folders/3x/fdmqc0bj3mx9qsq8nthrnt0h0000gn/T/tmpft5yj91a.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/3x/fdmqc0bj3mx9qsq8nthrnt0h0000gn/T/tmpft5yj91a.js
...
function findWasmBinary() {
    return locateFile('DesirePaths.wasm');
}
...
var ASM_CONSTS = {
 ...
 133918: () => { document.exitFullscreen(); },  
 133945: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 134018: () => { if (document.fullscreenElement) return 1; },  
 134064: () => { return Module.canvas.width; },  
 134096: () => { return screen.width; },  
 134121: () => { document.exitFullscreen(); },  
 134148: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 134281: () => { return window.innerWidth; },  
 134307: () => { return window.innerHeight; },  
 134334: () => { if (document.fullscreenElement) return 1; },  
 134380: () => { return Module.canvas.width; },  
 134412: () => { return parseInt(Module.canvas.style.width); },  
 134460: () => { if (document.fullscreenElement) return 1; },  
 134506: () => { return Module.canvas.width; },  
 134538: () => { return screen.width; },  
 134563: () => { return window.innerWidth; },  
 134589: () => { return window.innerHeight; },  
 134616: () => { if (document.fullscreenElement) return 1; },  
 134662: () => { return Module.canvas.width; },  
 134694: () => { return screen.width; },  
 134719: () => { document.exitFullscreen(); },  
 134746: () => { if (document.fullscreenElement) return 1; },  
 134792: () => { return Module.canvas.width; },  
 134824: () => { return parseInt(Module.canvas.style.width); },  
 134872: () => { document.exitFullscreen(); },  
 134899: ($0) => { Module.canvas.style.opacity = $0; },  
 134937: () => { return screen.width; },  
 134962: () => { return screen.height; },  
 134988: () => { return window.screenX; },  
 135015: () => { return window.screenY; },  
 135042: () => { return window.devicePixelRatio; },  
 135078: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 135131: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 135182: () => { Module.canvas.style.cursor = 'none'; },  
 135219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 135475: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 135526: () => { if (document.fullscreenElement) return 1; },  
 135572: () => { return window.innerWidth; },  
 135598: () => { return window.innerHeight; },  
 135625: () => { if (document.pointerLockElement) return 1; }
};
